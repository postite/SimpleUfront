...
class minject_point_PropertyInjectionPoint implements minject_point_InjectionPoint{
	...
	public function applyInjection($target, $injector) {
		...
		if($response === null) {
			...
			throw new HException("Injector is missing a mapping to handle injection into property \"" . _hx_string_or_null($this->field) . "\" of " . _hx_string_or_null(("object \"" . _hx_string_or_null(Type::getClassName($tmp)) . "\". Target dependency: \"" . _hx_string_or_null($this->type) . "\", named \"" . _hx_string_or_null($this->name) . "\"")));
		}
