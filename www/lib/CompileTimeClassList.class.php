...
CompileTimeClassList::$__meta__ = _hx_anonymous(array("obj" => _hx_anonymous(array("classLists" => (new _hx_array(array((new _hx_array(array("null,true,ufront.web.Controller", "control.HomeController,control.PartialController,ufront.app.DefaultUfrontController"))), (new _hx_array(array("null,true,ufront.api.UFApi", "TestApi"))), (new _hx_array(array("null,true,ufront.web.Controller", "control.HomeController,control.PartialController,ufront.app.DefaultUfrontController"))), (new _hx_array(array("null,true,ufront.api.UFApi", "TestApi"))), (new _hx_array(array("null,true,ufront.web.client.UFClientAction", ""))))))))));
